...
import { getStrategy, STRATEGY_TYPES } from '../calculators/strategyRegistry.js';
...
export const DISCLAIMERS = {
  ...
  sippFees: {
    ...
    icon: '💼',
    priority: 5,
    appliesTo: ['sp500', 'nasdaq100', 'ftse100', 'goldEtf', 
  ...
  currencyRisk: {
    ...
    icon: '💱',
    priority: 6,
    appliesTo: ['sp500', 'nasdaq100', 'gold-sp500', 'gold-nasdaq100', 
